...
FP_Application_Analytics is designed to sit at an application level utilizing multiple other FuzzPhyte libraries. This relies heavily on FuzzPhyte Utility Analytics as well as FuzzPhyte XR.
